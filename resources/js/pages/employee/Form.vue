...
import { ArrowLeft, Check, LucideFileQuestion, Plus } from '@lucide/vue';
import { h, onMounted, reactive, ref } from 'vue';
import { toast } from 'vue-sonner';
import Tooltip from '@/usable/Tooltip.vue';
import Dialog from '@/usable/Dialog.vue';
import { store as createGroup } from '@/routes/masterfile/group';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="px-4 py-6">
            <div class="flex items-center justify-between">
                <Heading :title="isAdd ? 'Add Employee' : 'Update Employee'" :description="isAdd
                    ? 'Manage your new Employee'
                    : 'Update selected Employee'
                    " />
                <Button class="cursor-pointer" type="button" @click="handleCancel">
                    <ArrowLeft /> Back
                </Button>
            </div>
            ...
            <div class="space-y-4">
                <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-4">
                    <div class="grid grid-rows-[auto_auto_20px] gap-2 col-span-3">
                        ...
                        <Input id="employee_number" v-model="form.EmpNbr" type="text" class="mt-1 block w-full"
                            autocomplete="employee-number" placeholder="Employee Number" />
                    ...
                    <div class="grid grid-rows-[auto_auto_20px] gap-2">
                        ...
                        <div class="flex items-center gap-2">
                            <Combobox :items="groups" v-model="form.Group" :labelText="'Select a group'" />
                            <Tooltip description="Add new group">
                                <Button @click="showGroupDialog" variant="outline" class="cursor-pointer">
                ...
                <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-4">
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <Input id="first_name" v-model="form.FirstName" type="text" class="mt-1 block w-full"
                            autocomplete="firstname" placeholder="First Name" />
                        <InputError :message="props.errors.FirstName" />
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="middle_name">Middle Name</Label>
                        <Input id="middle_name" v-model="form.MidName" type="text" class="mt-1 block w-full"
                            autocomplete="middlename" placeholder="Middle Name" />
                        <InputError :message="props.errors.MidName" />
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="last_name">Last Name</Label>
                        <Input id="last_name" v-model="form.LastName" type="text" class="mt-1 block w-full"
                            autocomplete="lastname" placeholder="Last Name" />
                        <InputError :message="props.errors.LastName" />
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="suffix">Suffix</Label>
                        <Input id="suffix" v-model="form.Suffix" type="text" class="mt-1 block w-full"
                            autocomplete="suffix" placeholder="Jr., Sr., I, II, etc" />
                    </div>
                </div>
                <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <Input id="city_province" v-model="form.CityProv" type="text" class="mt-1 block w-full"
                            autocomplete="city-province" placeholder="City/Province" />
                ...
                <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-2">
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <DatePicker v-model="form.BirthDate" placeholder="Select birth date" />
                        <InputError :message="props.errors.BirthDate" />
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="date_of_employments">Date of Employment</Label>
                        <DatePicker v-model="form.EmployDate" placeholder="Select date of employment" />
                ...
                <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-3">
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <Input id="position" v-model="form.Position" type="text" class="mt-1 block w-full"
                            autocomplete="position" placeholder="Position" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="area_of_assignment">Area of Assignment</Label>
                        <Input id="area_of_assignment" v-model="form.Assignment" type="text" class="mt-1 block w-full"
                            autocomplete="area-of-assignment" placeholder="Area of Assignment" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="salary_grade">Salary Grade</Label>
                        <Input id="salary_grade" v-model="form.SalaryGrade" type="text" class="mt-1 block w-full"
                            autocomplete="salary-grade" placeholder="Salary Grade" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                </div>
                <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-4">
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <NumberField v-model="form.BasicPay" class="mt-1 block w-full" id="basic_pay" :step="0.01"
                            :locale="'en-PH'" :format-options="{
                                style: 'currency',
                                currency: 'PHP',
                    ...
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <NumberField v-model="form.DailyRate" class="mt-1 block w-full" id="daily_rate" :step="0.01"
                            :locale="'en-PH'" :format-options="{
                                style: 'currency',
                                currency: 'PHP',
                                minimumFractionDigits: 2,
                    ...
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <NumberField v-model="form.HourlyRate" class="mt-1 block w-full" id="hourly_rate" :step="0.01"
                            :locale="'en-PH'" :format-options="{
                                style: 'currency',
                                currency: 'PHP',
                                minimumFractionDigits: 2,
                    ...
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <Input id="status" v-model="form.Status" type="text" class="mt-1 block w-full"
                ...
                <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-4">
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <Input id="sss_number" v-model="form.SSSNbr" type="text" class="mt-1 block w-full"
                            autocomplete="sss-number" placeholder="XX-XXXXXXX-X" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="phic_number">PHIC Number</Label>
                        <Input id="phic_number" v-model="form.PHICNbr" type="text" class="mt-1 block w-full"
                            autocomplete="phic-number" placeholder="XX-XXXXXXXXX-X" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="hdmf_number">HDMF Number</Label>
                        <Input id="hdmf_number" v-model="form.HDMFNbr" type="text" class="mt-1 block w-full"
                            autocomplete="hdmf-number" placeholder="XXXX-XXXX-XXXX" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="tin_number">TIN Number</Label>
                        <Input id="tin_number" v-model="form.TIN" type="text" class="mt-1 block w-full"
                            autocomplete="tin-number" placeholder="XXX-XXX-XXX" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                </div>
                <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-3">
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <Input id="degree_educational_attainment" v-model="form.Degree" type="text"
                            class="mt-1 block w-full" autocomplete="degree-educational-attainment"
                            placeholder="Degree / Educational Attainment" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="allowances_regularly_received">Allowances Regularly Received</Label>
                        <NumberField v-model="form.AllowReg" class="mt-1 block w-full"
                            id="allowances_regularly_received" :step="0.01" :locale="'en-PH'" :format-options="{
                                style: 'currency',
                                currency: 'PHP',
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2,
                    ...
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <DatePicker v-model="form.ResignDate" placeholder="Select date of resignation"></DatePicker>
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                </div>
                <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-4">
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        ...
                        <Input id="bpi_atm_no" v-model="form.BPIATM" type="text" class="mt-1 block w-full"
                            autocomplete="bpi-atm-no" placeholder="BPI ATM No." />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="bpi_employee_code">BPI Employee Code</Label>
                        <Input id="bpi_employee_code" v-model="form.BPIEmpCode" type="text" class="mt-1 block w-full"
                            autocomplete="bpi-employee-code" placeholder="BPI Employee Code" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="pin">PIN</Label>
                        <Input id="pin" v-model="form.PIN" type="password" class="mt-1 block w-full" autocomplete="pin"
                            placeholder="PIN" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                    <div class="grid grid-rows-[auto_auto_15px] gap-2">
                        <Label for="peraa_id">PERAA ID</Label>
                        <Input id="peraa_id" v-model="form.PERAAID" type="password" class="mt-1 block w-full"
                            autocomplete="peraa-id" placeholder="PERAA ID" />
                        <!-- <InputError :message="errors.current_password" /> -->
                    </div>
                </div>
                <div class="flex justify-end gap-4">
                    <Button class="cursor-pointer" variant="outline" type="button" @click="handleCancel">Cancel</Button>
        ...
        <Dialog v-model:visible="visible" title="Add Group" description="Manage your new group" @save="onSaveGroup">
            <div class="grid gap-4">
                <div class="grid gap-2 ">
                    <Label for="group_code">Code</Label>
                    <Input v-model="group.Code" id="group_code" name="group_code" type="text" placeholder="Code" />
                ...
                <div class="grid gap-2">
                    ...
                    <Input v-model="group.Description" id="group_description" name="group_description" type="text"
