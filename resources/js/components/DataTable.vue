        ...
        <div class="flex items-center justify-end ">
            ...
            <div class="flex w-full items-center gap-8 lg:w-fit">
                ...
                <div class="ml-auto flex items-center gap-2 lg:ml-0">
                    <Button
                        variant="outline"
                        class=" cursor-pointer hidden h-8 w-8 p-0 lg:flex"
                        :disabled="!data.prev_page_url"
                        @click="router.visit(data.first_page_url)"
                    >
                    ...
                    <Button
                        variant="outline"
                        class=" cursor-pointer hidden size-8 lg:flex"
                        size="icon"
                        :disabled="!data.next_page_url"
                        @click="router.visit(data.last_page_url)"
                    >
